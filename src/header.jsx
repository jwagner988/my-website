...
const Header = () => {
    ...
    return (
        <div className="header">
            ...
            <p className="desc">I'm a full-stack software engineer who's most recent work was as a core contributor to and Open-source product called SeeQR.  blah blah blah</p>
            <ul>
                {/* <li><a>Resume</a></li> */}
